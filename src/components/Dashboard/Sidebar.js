    ...
    <section className="sidebar">
      <div className="content pt-50 pb-30 ps-30">
        <div className="user text-center pb-50 pe-30">
          <img src={Profile} alt="Profile" width="90" height="90" className="img-fluid mb-20" />
        ...
        <div className="menus">
          <div className="item active mb-30">
            ...
            <p className="item-title m-0">
              <Link to="/member" className="text-lg text-decoration-none">
                Overview
              </Link>
            </p>
          </div>
          <div className="item mb-30">
            ...
            <p className="item-title m-0">
              <Link to="/member/transactions" className="text-lg text-decoration-none">
                Transactions
              </Link>
            </p>
          </div>
          ...
          <div className="item mb-30">
            ...
            <p className="item-title m-0">
              <Link to="/member/edit-profile" className="text-lg text-decoration-none">
                Settings
              </Link>
            </p>
          </div>
        ...
        <div className="sidebar-footer pt-73 pe-30">
          <div className="footer-card">
            <div className="d-flex justify-content-between mb-20">
              <img src={step3} alt="Winner" width={50} height={50} />
              <p className="fw-medium color-palette-1">
                Top Up &<br />
                Be The Winner
              </p>
            </div>
            <Link className="btn btn-get-started w-100 fw-medium text-xs text-center text-white rounded-pill" to="/member">
              Get Started
            </Link>
          </div>
        </div>
